...
export const SET_DRAWING_FROM_API = 'SET_DRAWING_FROM_API';
export const SET_CLIENT_ID = 'SET_CLIENT_ID';
export const SET_DRAWING_ID = 'SET_DRAWING_ID';
export const DUPLICATE_DRAWING = 'DUPLICATE_DRAWING';
export const LOCK_DRAWING = 'LOCK_DRAWING';
export const UNLOCK_DRAWING = 'UNLOCK_DRAWING';
export const SET_DRAWING_VISIBILITY = 'SET_DRAWING_VISIBILITY';